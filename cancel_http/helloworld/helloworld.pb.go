...
type SleepRequest struct {
	...
	TimeInSec  int32 `protobuf:"varint,1,opt,name=time_in_sec,json=timeInSec,proto3" json:"time_in_sec,omitempty"`
	WantCancel bool  `protobuf:"varint,2,opt,name=wantCancel,proto3" json:"wantCancel,omitempty"`
}
...
func (x *SleepRequest) GetTimeInSec() int32 {
	if x != nil {
		return x.TimeInSec
	}
	return 0
...
func (x *SleepRequest) GetWantCancel() bool {
	if x != nil {
		return x.WantCancel
	}
	return false
...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x4e, 0x0a, 0x0c, 0x53, 0x6c,
	0x65, 0x65, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1e, 0x0a, 0x0b, 0x74, 0x69,
	0x6d, 0x65, 0x5f, 0x69, 0x6e, 0x5f, 0x73, 0x65, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x49, 0x6e, 0x53, 0x65, 0x63, 0x12, 0x1e, 0x0a, 0x0a, 0x77, 0x61,
	0x6e, 0x74, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a,
	0x77, 0x61, 0x6e, 0x74, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x22, 0x0c, 0x0a, 0x0a, 0x53, 0x6c,
	0x65, 0x65, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x86, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65,
	...
	0x6c, 0x79, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x05, 0x53, 0x6c, 0x65, 0x65, 0x70, 0x12, 0x18, 0x2e,
	0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x53, 0x6c, 0x65, 0x65, 0x70,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77,
	0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x53, 0x6c, 0x65, 0x65, 0x70, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22,
...
var file_helloworld_proto_goTypes = []interface{}{
	...
	(*SleepRequest)(nil), // 2: helloworld.SleepRequest
	(*SleepReply)(nil),   // 3: helloworld.SleepReply
}
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: helloworld.Greeter.SayHello:input_type -> helloworld.HelloRequest
	2, // 1: helloworld.Greeter.Sleep:input_type -> helloworld.SleepRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	3, // 3: helloworld.Greeter.Sleep:output_type -> helloworld.SleepReply
...
func (c *greeterClient) Sleep(ctx context.Context, in *SleepRequest, opts ...grpc.CallOption) (*SleepReply, error) {
	out := new(SleepReply)
	err := c.cc.Invoke(ctx, "/helloworld.Greeter/Sleep", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGreeterServer) Sleep(context.Context, *SleepRequest) (*SleepReply, error) {
...
func _Greeter_Sleep_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SleepRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).Sleep(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.Greeter/Sleep",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Sleep(ctx, req.(*SleepRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Greeter_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Sleep",
			Handler:    _Greeter_Sleep_Handler,
		},
	},
